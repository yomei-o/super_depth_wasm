...
sh tools/cc.sh -O2 -Wall -Wextra -Isrc -o tests/frames.exe \
   tests/frames.c tests/png.c src/bfnt.c src/video.c src/text.c src/sound.c src/game.c src/stage_sea.c src/stage_sky.c src/stage_space.c src/stage_boss.c src/title.c src/record.c src/cut.c src/name.c
