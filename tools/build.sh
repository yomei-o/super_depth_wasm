...
sh tools/cc.sh -O2 -Wall -Wextra -mwindows -Isrc \
   -o depth.exe src/main_win32.c src/game.c src/stage_sea.c src/stage_sky.c src/stage_space.c src/stage_boss.c src/title.c src/video.c src/text.c src/bfnt.c src/sound.c \
